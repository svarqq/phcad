...
from phcad.models.cbam import CBAM


# Credits to: https://github.com/hendrycks/ss-ood
class WideResNet18(nn.Module):
    def __init__(self, rep_dim=256, clf=False, **kwargs):
        super().__init__()
        self.inplanes = 64
        self.clf = clf
        self.phcal = False
        ...
        self.layer2 = self._make_layer(
            BasicBlock, 128, layers[1], stride=2, att_type=att_type
        )
        self.layer3 = self._make_layer(
            BasicBlock, 256, layers[2], stride=2, att_type=att_type
        )
        self.layer4 = self._make_layer(
            BasicBlock, 512, layers[3], stride=2, att_type=att_type
        )
